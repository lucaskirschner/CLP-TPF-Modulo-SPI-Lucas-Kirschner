...
HD_PWD='C:/Users/Noxie/Desktop/clp-tp-final/Sintesis/spi_top_vio_ila.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_top_vio_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_top_vio_ila.tcl

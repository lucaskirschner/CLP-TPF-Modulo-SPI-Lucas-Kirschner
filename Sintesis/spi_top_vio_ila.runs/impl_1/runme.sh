...
HD_PWD='C:/Users/Noxie/Desktop/clp-tp-final/Sintesis/spi_top_vio_ila.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_top_vio_ila.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_top_vio_ila.tcl -notrace
